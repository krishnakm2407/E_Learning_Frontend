...
const UpdateChapter = () => {
  ...
  useEffect(() => {
    axios.get(`https://e-learning-backend-28nz.onrender.com/api/v1/getChapter/${subjectId}/${chapterId}`)
      .then(result => {
        console.log(result);
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios
      .put(`https://e-learning-backend-28nz.onrender.com/api/v1/updateChapter/${subjectId}/${chapterId}`, {
        chapterName,
        description,
        videoLinks,
        driveLink,
